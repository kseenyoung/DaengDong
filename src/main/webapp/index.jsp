        ...
        <section id="section2">
            ...
            <div id="sec2_right">
                ...
                <div id="div1">
                  ...
                  <p>혼자서 하는 여행도 좋지만, 함께 할 때 여행의 즐거움은 배가 됩니다. 마음이 맞는 사람과 같이 여행을 떠나봐요.</p>
                  <img src="${path}/img/main3.png">
                </div>
                <div id="div2">
                    <div>
                        <h2>여행 지금 바로 계획하자</h2>
                        <p>언제 어디서든 쉽고 간편하게 일정을 같이 계획하고 수정해 보세요. 동행자도 초대해 같이 대화하며 완성해봐요.</p>
                        <img src="${path}/img/main5.png">
                    </div>
                </div>
